...
<div id="app">
    ...
    <main class="container">
        <div class="page-head">
            <div class="page-head-icon"><i class="bi bi-gear"></i></div>
            <div>
                <h1>Pengaturan INHAL</h1>
                <p>Konfigurasi master, pengguna, email, dan alur status</p>
            </div>
        </div>
        <div class="card">
            <div class="card-note">
                <i class="bi bi-cursor"></i>
                <span>Kerangka halaman pengaturan. Login admin dan tab konfigurasi ditambahkan pada tahap berikutnya.</span>
            </div>
