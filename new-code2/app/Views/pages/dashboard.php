...
<div id="app">
    ...
    <main class="container">
        <div class="page-head">
            ...
            <div>
                <h1>Dashboard INHAL</h1>
                <p>Operasional dan pengelolaan pengajuan</p>
            </div>
        </div>
        <div class="card">
            <div class="card-note">
                <i class="bi bi-cursor"></i>
                <span>Kerangka halaman dashboard. Login admin, tab pengajuan, statistik, dan berita acara ditambahkan pada tahap berikutnya.</span>
            </div>
