...
<div id="app">
    ...
    <main class="container">
        <div class="page-head">
            <div class="page-head-icon"><i class="bi bi-search"></i></div>
            <div>
                <h1>Portal Mahasiswa INHAL</h1>
                <p>Pantau status pengajuan kegiatan Anda</p>
            </div>
        </div>
        <div class="card">
            <div class="card-note">
                <i class="bi bi-cursor"></i>
                <span>Kerangka halaman portal. Pencarian NPM dan riwayat status ditambahkan pada tahap berikutnya.</span>
            </div>
